...
const styles = {
  page: { padding: '24px 16px 48px', maxWidth: 960, margin: '0 auto' },
  ...
  heroTitle: { fontSize: 28, fontWeight: 800, fontFamily: 'Sora, sans-serif', marginBottom: 10 },
  heroSub: { fontSize: 14, color: 'var(--color-text-secondary)', maxWidth: 620, margin: '0 auto', lineHeight: 1.6 },
  ...
  topCardsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 20, marginBottom: 28 },
  balanceCard: { padding: 22, borderRadius: 16, background: 'linear-gradient(135deg, rgba(104,245,225,0.06) 0%, rgba(20,20,20,0.6) 100%)', border: '1px solid rgba(104,245,225,0.3)' },
  ...
  coinCount: { fontSize: 38, fontWeight: 900, fontFamily: 'Sora, sans-serif', color: '#fff', letterSpacing: -1 },
  currencyEquiv: { fontSize: 16, color: 'var(--color-cyan)', fontWeight: 700 },
