...
const styles = {
  page: { padding: '24px 16px 48px', maxWidth: 1100, margin: '0 auto' },
  heroCard: {
    display: 'flex', gap: 28, padding: 24, marginBottom: 36,
    background: 'var(--color-bg-elevated)', borderRadius: 16,
    flexWrap: 'wrap',
  },
  posterWrap: {
    width: '100%', maxWidth: 220, borderRadius: 12, overflow: 'hidden',
    boxShadow: '0 12px 36px rgba(0,0,0,0.5)', flexShrink: 0, margin: '0 auto',
  },
  poster: { width: '100%', height: '100%', objectFit: 'cover', display: 'block', aspectRatio: '2/3' },
  heroDetails: { flex: 1, minWidth: 260, display: 'flex', flexDirection: 'column' },
  eyebrowRow: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12, flexWrap: 'wrap' },
  statusBadge: {
    fontSize: 11, fontWeight: 800, textTransform: 'uppercase', letterSpacing: 0.6,
    padding: '4px 8px', borderRadius: 6, background: 'var(--gradient-primary)', color: '#04120F',
  },
  ratingBadge: {
  ...
  title: { fontSize: 28, fontWeight: 800, lineHeight: 1.15, margin: '0 0 10px', fontFamily: 'Sora, sans-serif' },
  metaRow: { display: 'flex', alignItems: 'center', gap: 8, color: 'var(--color-text-secondary)', fontSize: 13, marginBottom: 16, flexWrap: 'wrap' },
  dot: { width: 3, height: 3, borderRadius: '50%', background: 'var(--color-text-muted)' },
  desc: { color: 'var(--color-text-secondary)', fontSize: 14, lineHeight: 1.6, maxWidth: 640, marginBottom: 20 },
  actionRow: { marginTop: 'auto', display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' },
  favBtn: { display: 'flex', alignItems: 'center', gap: 8, padding: '9px 16px', borderRadius: 10, fontWeight: 600, fontSize: 13 },
