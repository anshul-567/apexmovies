...
const styles = {
  ...
  heroContent: { position: 'relative', padding: '0 24px 36px', maxWidth: 620 },
  heroEyebrow: {
    display: 'inline-flex', fontSize: 11, fontWeight: 700, letterSpacing: 1.2, textTransform: 'uppercase',
    color: '#04120F', background: 'var(--gradient-primary)', padding: '5px 10px', borderRadius: 6, marginBottom: 12,
  },
  heroTitle: { fontSize: 32, fontWeight: 800, lineHeight: 1.1, letterSpacing: -0.8, marginBottom: 10, fontFamily: 'Sora, sans-serif' },
  heroMeta: { display: 'flex', alignItems: 'center', gap: 10, fontSize: 12.5, color: 'var(--color-text-secondary)', marginBottom: 14, flexWrap: 'wrap' },
  ...
  heroDesc: { fontSize: 14, color: 'var(--color-text-secondary)', lineHeight: 1.5, maxWidth: 460, marginBottom: 20 },
  heroBtnPrimary: { fontSize: 14, padding: '12px 20px' },
  searchWrap: { padding: '0 16px', position: 'relative', zIndex: 5, marginBottom: 24 },
  searchBar: { display: 'flex', alignItems: 'stretch', padding: 8, boxShadow: '0 20px 60px rgba(0,0,0,0.5)', flexWrap: 'wrap', gap: 6 },
  searchField: { flex: 1, minWidth: 130, display: 'flex', flexDirection: 'column', gap: 4, padding: '8px 12px', borderRight: '1px solid var(--color-border)' },
